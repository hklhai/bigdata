...
public class Cartesian {
    public static void main(String[] args) {
        ...
        JavaPairRDD<String, String> cartesian = clothesRDD.cartesian(trousersRDD);


        for (Tuple2<String, String> member : cartesian.collect()) {
            System.out.println(member._1 + " " + member._2);
        }
        sc.close();
    }
