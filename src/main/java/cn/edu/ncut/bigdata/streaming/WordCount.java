...
public class WordCount {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Spark Streaming程序
        SparkConf conf = new SparkConf().setAppName("CreateDataFrame").setMaster("local[2]");
        ...
        JavaPairDStream<String, Integer> wordCount = word.reduceByKey(new Function2<Integer, Integer, Integer>() {
            @Override
